# `@sebastienrousseau/go-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/go-config`.
...
- [x] **.golangci.yml**: Standardized rule preset
- [x] **staticcheck.conf**: Standardized rule preset
