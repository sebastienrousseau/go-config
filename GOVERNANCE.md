...
This document describes how @sebastienrousseau/go-config is run: who decides what, how
...
@sebastienrousseau/go-config is **maintainer-led**. As of the current release line it has a single
