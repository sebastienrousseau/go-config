...
lp=lm?'/go-config/'+lm[1]:'/go-config';
function load(){if(idx)return Promise.resolve();var sp=lm?'/go-config/'+lm[1]+'/search-index.json':'/go-config/search-index.json';return fetch(sp).then(function(r){return r.json()}).then(function(d){idx=d.entries||[]}).catch(function(){idx=[]})}
